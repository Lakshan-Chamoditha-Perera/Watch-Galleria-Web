...
const Common = () => {
    ...
    return (<div className=' pb-10'>
            <div className="bg-[#F8FAFA] py-5 h-[93vh] px-[13.33vw] grid grid-cols-2">
                <div id="left_div"
                     className="h-full bg-[#F8FAFA] p-8 flex flex-col justify-center items-start text-black">
                ...
                <div className="bg-[#F8FAFA] flex justify-center items-center">
            ...
            <div className="min-h-[100vh] px-[13.33vw] my-auto">
                <div>
                    ...
                    <p className="text-left text-[32px] mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
